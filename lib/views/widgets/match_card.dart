                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        match.predictions.result.predicted_outcome,
                        style: const TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                          color: Color(0xFF0A1F3D),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${match.predictions.result.home_win_prob}%',
                        style: const TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                          color: Color(0xFF0A1F3D),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        match.predictions.result.confidence,
                        style: const TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                          color: Color(0xFF0A1F3D),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '${match.predictions.result.confidence_score}%',
                        style: const TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                          color: Color(0xFF0A1F3D),
